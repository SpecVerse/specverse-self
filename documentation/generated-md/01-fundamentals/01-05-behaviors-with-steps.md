...
This completes the fundamentals series. Continue to [Example 02-01: Using Profiles](../profiles/02-01-using-profiles) to learn about extending models with profiles.

## Related Examples

- [Example 01-03: Model with Behaviors](./01-03-model-with-behaviors) - Foundation of behaviors without steps
- [Example 03-02: Controllers and Actions](../architecture/03-02-controllers-and-actions) - Advanced controller patterns
- [Example 03-03: Services and Events](../architecture/03-03-services-and-events) - Service operation patterns