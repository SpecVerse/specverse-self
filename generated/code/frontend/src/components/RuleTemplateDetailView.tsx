...
function RuleTemplateDetailView() {
  ...
  const selectedEntity = useMemo(
    () => modelData.RuleTemplate?.find((e: any) => e.id === selectedEntityId) || null,
  ...
  // Detect pattern
  const pattern = patternAdapter.detectPattern({ type: 'detail', model: 'RuleTemplate' });
  ...
  const context = {
    pattern,
    viewSpec: { type: 'detail', model: ["RuleTemplate"], name: 'RuleTemplateDetailView' },
    modelData,
    modelSchemas,
