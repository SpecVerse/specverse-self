...
function RelationshipDetailView() {
  ...
  const selectedEntity = useMemo(
    () => modelData.Relationship?.find((e: any) => e.id === selectedEntityId) || null,
  ...
  // Detect pattern
  const pattern = patternAdapter.detectPattern({ type: 'detail', model: 'Relationship' });
  ...
  const context = {
    pattern,
    viewSpec: { type: 'detail', model: ["Relationship"], name: 'RelationshipDetailView' },
    modelData,
    modelSchemas,
