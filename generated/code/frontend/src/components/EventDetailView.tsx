...
function EventDetailView() {
  ...
  }), [events, attributes, eventversions]);
  ...
  const selectedEntity = useMemo(
    () => modelData.Event?.find((e: any) => e.id === selectedEntityId) || null,
  ...
  if (isLoadingEvent || isLoadingAttribute || isLoadingEventVersion) {
    return <div className="p-4">Loading...</div>;
  }
  
  // Detect pattern
  const pattern = patternAdapter.detectPattern({ type: 'detail', model: 'Event' });
  ...
  const context = {
    pattern,
    viewSpec: { type: 'detail', model: ["Event","Attribute","EventVersion"], name: 'EventDetailView' },
    modelData,
    modelSchemas,
    primaryModel: 'Event',
    selectedEntity,
