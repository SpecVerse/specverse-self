...
interface ProfileFormProps {
  ...
  onValidate?: (data: ProfileFormData) => void;
  onDelete?: () => void;
  onCancel?: () => void;
  isDeleting?: boolean;
 ...
 */
export function ProfileForm({ profile, onSubmit, onValidate, onDelete, onCancel, isDeleting, isValidating }: ProfileFormProps) {
  const {
    register,
    handleSubmit,
    getValues,
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="profile-form space-y-4" autoComplete="off" data-lpignore="true" data-form-type="other">
