/**
 * ServiceForm
 * Form component for creating/editing Service
 */
...
interface ServiceFormProps {
  ...
  onValidate?: (data: ServiceFormData) => void;
  onDelete?: () => void;
  onCancel?: () => void;
  isDeleting?: boolean;
 ...
 */
export function ServiceForm({ service, onSubmit, onValidate, onDelete, onCancel, isDeleting, isValidating }: ServiceFormProps) {
  const {
    register,
    handleSubmit,
    getValues,
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="service-form space-y-4" autoComplete="off" data-lpignore="true" data-form-type="other">
