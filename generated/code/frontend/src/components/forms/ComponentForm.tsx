/**
 * ComponentForm
 * Form component for creating/editing Component
 */
...
interface ComponentFormProps {
  ...
  onValidate?: (data: ComponentFormData) => void;
  onDelete?: () => void;
  onCancel?: () => void;
  isDeleting?: boolean;
 ...
 */
export function ComponentForm({ component, onSubmit, onValidate, onDelete, onCancel, isDeleting, isValidating }: ComponentFormProps) {
  const {
    register,
    handleSubmit,
    getValues,
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="component-form space-y-4" autoComplete="off" data-lpignore="true" data-form-type="other">
