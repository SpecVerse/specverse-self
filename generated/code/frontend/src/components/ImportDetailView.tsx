...
function ImportDetailView() {
  ...
  const selectedEntity = useMemo(
    () => modelData.Import?.find((e: any) => e.id === selectedEntityId) || null,
  ...
  // Detect pattern
  const pattern = patternAdapter.detectPattern({ type: 'detail', model: 'Import' });
  ...
  const context = {
    pattern,
    viewSpec: { type: 'detail', model: ["Import"], name: 'ImportDetailView' },
    modelData,
    modelSchemas,
    primaryModel: 'Import',
    selectedEntity,
