...
function ProfileDetailView() {
  ...
  const selectedEntity = useMemo(
    () => modelData.Profile?.find((e: any) => e.id === selectedEntityId) || null,
  ...
  // Detect pattern
  const pattern = patternAdapter.detectPattern({ type: 'detail', model: 'Profile' });
  ...
  const context = {
    pattern,
    viewSpec: { type: 'detail', model: ["Profile"], name: 'ProfileDetailView' },
    modelData,
    modelSchemas,
