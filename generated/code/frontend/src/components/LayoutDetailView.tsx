...
function LayoutDetailView() {
  ...
  const selectedEntity = useMemo(
    () => modelData.Layout?.find((e: any) => e.id === selectedEntityId) || null,
  ...
  // Detect pattern
  const pattern = patternAdapter.detectPattern({ type: 'detail', model: 'Layout' });
  ...
  const context = {
    pattern,
    viewSpec: { type: 'detail', model: ["Layout"], name: 'LayoutDetailView' },
    modelData,
    modelSchemas,
    primaryModel: 'Layout',
    selectedEntity,
