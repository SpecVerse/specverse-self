...
import VSCodeExtensionRoutes from './routes/VSCodeExtensionController.js';
import ExtensionLanguageRoutes from './routes/ExtensionLanguageController.js';
import ExtensionCommandRoutes from './routes/ExtensionCommandController.js';
import ExtensionThemeRoutes from './routes/ExtensionThemeController.js';
...
import { VSCodeExtensionRelationshipService } from './services/VSCodeExtensionRelationshipService.js';
...
import { VSCodeExtensionController } from './controllers/VSCodeExtensionController.js';
import { ExtensionLanguageController } from './controllers/ExtensionLanguageController.js';
import { ExtensionCommandController } from './controllers/ExtensionCommandController.js';
import { ExtensionThemeController } from './controllers/ExtensionThemeController.js';
...
async function start() {
  ...
  const vSCodeExtensionRelationshipService = new VSCodeExtensionRelationshipService(prisma);
  ...
  const vSCodeExtensionController = new VSCodeExtensionController();
  const extensionLanguageController = new ExtensionLanguageController();
  const extensionCommandController = new ExtensionCommandController();
  const extensionThemeController = new ExtensionThemeController();
  ...
  const aIWorkflowController = new AIWorkflowController();
    ...
    VSCodeExtensionRelationshipService: vSCodeExtensionRelationshipService,
  ...
  await app.register(VSCodeExtensionRoutes, {
    prefix: '/api/vscodeextensions',
    controllers: {
      VSCodeExtensionController: vSCodeExtensionController
    },
    services: services
  });
  await app.register(ExtensionLanguageRoutes, {
    prefix: '/api/extensionlanguages',
    controllers: {
      ExtensionLanguageController: extensionLanguageController
    },
    services: services
  });
  await app.register(ExtensionCommandRoutes, {
    prefix: '/api/extensioncommands',
    controllers: {
      ExtensionCommandController: extensionCommandController
    },
    services: services
  });
  await app.register(ExtensionThemeRoutes, {
    prefix: '/api/extensionthemes',
    controllers: {
      ExtensionThemeController: extensionThemeController
    },
    services: services
  });
