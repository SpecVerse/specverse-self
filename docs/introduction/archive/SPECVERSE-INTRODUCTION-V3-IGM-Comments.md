<!--We should try getting the diagrams redrawn by Gemini Nano Banana.--> 

# SpecVerse: A Structured Language for Human-AI Software Collaboration

<!--The title isn't pithy enough. Think "Attention is all you need" - what's the equivalent for SpecVerse? And is SpecVerse really a language specification?-->
...
<!-- Traditional specification isn't wrong: it's now too rigid and unpalatable(?) by AIs in an agentic world. The 'new' AI paradigm of Spec-Driven Development is great but the current approaches/methods/implementations/tools are 'toys' in an Entreprise IT context. -->
...
<!-- be positive: "SpecVerse Fills the Gap" -->
...
<!--Validated automatically or verified automatically?--> 
...
<!--Add another SpecVerse between the second and third boxes.-->
...
<!--I'm not sure "Exploration mode" is correct. And what does "ai template" mean? SpecVerse specs are co-created by humans + LLMs not solely by LLMs.-->
...
<!--I'm not sure what "Replay mode" and "realize" mean either. Don't say milliseconds, that's runtime specific --> 
...
<!--This diagram doesn't work for me.--> 
...
<!--Prisma, Fastify, and React are specific technologies. They aren't SpecVerse specific, so why mention them?--> 
...
<!--UML, formal methods, Model-Driven Architecture have been used to defined software architecture to serve as sources of truth. Why don't they work in today's AI Agentic world? And why will SpecVerse 'help'?--> 

<!--But keep this as a philosophical point, not a practical explanation.--> 
...
<!--Validatable is a horrible word. Is verifiable is better?--> 
...
<!--This diagram is weak. And shouldn't include .specly as a detail--> 
...
<!--Again, should we really be talking about technologies here?-->
...
<!--Remove the `from human request` brackets.--> 
...
<!--Pillar four, AI implementable, should become before AI describable. Remove the 'from System Analysis)'. --> 
...
<!--Perhaps this section should be AI-Verifiable? And combined with the Closed Loop section below.-->
...
<!--This diagram isn't a loop. Where's the loop in this?--> 
...
<!--I think we're still missing a pillar five. Which is something about being able to derive a specification from existing code--> 
...
<!--Again, this isn't a loop as far as I can tell.--> 
...
<!--The title of this section is not right because you go from three architectural layers to inference Engine which is not actually a part of the.spec please specification--> 
...
<!--Do we need to 'Retrieve_many' in this list?--> 
...
<!--You haven't said that it's AI in the LLM sense? Why say this isn't AI in the LLM sense?--> 
...
<!--Make this about the positives of what SpecVerse/Specly can do.--> 

<!--Is it language coverage or is it spec-verse coverage? Is it a fundamental problem that specly can't do something, or is it something that hasn't been implemented yet?--> 
...
<!--Is this what's currently missing, or what is implemented and could be added? Or are these fundamental limitations? Spin this in a positive sense. Don't include the detail here. move the detail to the appendix--> 
...
<!--Is analytics really the most significant? What about user interfaces? Haven't we still got a problem there?--> 
...
<!--This is good as a conclusion and should be: this is what makes SpecVerse special or something like that.--> 
...
<!--And perhaps they should become just before the punch line of what makes SpecVerse special.--> 
...
<!--Is this last paragraph the ultimate punchline or tagline for SpecVerse?--> 
